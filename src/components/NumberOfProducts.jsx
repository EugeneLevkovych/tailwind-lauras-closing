export default function NumberOfProducts() {
    return (
        <div className="flex justify-between max-w-(--my-break-xl) mx-auto px-4 py-12">
            ...
            <div className="space-x-1">
                <label className="text-gray-light font-normal" for="sort-by">Sort by:</label>
                <select className="text-gray-dark font-semibold" name="sort-by">

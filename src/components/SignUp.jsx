export default function SignUp() {
    return (
            <form className="mb-[4rem]">
                ...
                <input className="max-w-103 w-full h-11 pl-4 border-1 border-gray-lighter mb-[1.1rem]" type="text" id="subscribe" placeholder="Your email" />
                <button className="max-w-[8.3rem] w-full h-11 xl:ml-2 bg-gray1 text-sm font-semibold tracking-wider uppercase text-white2" type="submit">Subscribe</button>

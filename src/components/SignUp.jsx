export default function SignUp() {
    return (
        <form className="mb-[3rem] xl:mb-[3.9rem]">
            ...
            <input className="lg:max-w-70 xl:max-w-99 w-full h-11 pl-4 border-1 border-gray-lighter mb-[1.1rem] outline-green-400" type="text" id="subscribe" placeholder="Your email" />
            <button className="lg:max-w-30 xl:max-w-[8.3rem] w-full h-11 lg:ml-2 bg-gray1 text-sm font-semibold tracking-wider uppercase text-white2 mb-[1.1rem] cursor-pointer" type="submit">Subscribe</button>
